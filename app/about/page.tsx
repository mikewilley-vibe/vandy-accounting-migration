...
export default function AboutPage() {
  ...
  className="
    ...
    md:ml-8
    md:mt-0
    transition-smooth hover:shadow-lg hover:ring-slate-900/10
  "
/>

        <h1 className="animate-fade-in-up animation-delay-200 mt-2 text-4xl md:text-5xl font-bold tracking-tight text-slate-900">
          Meet Julie L. Riess
        </h1>
...
<section className="mt-20">
  ...
  <div className="mt-10 grid gap-6 lg:grid-cols-2 lg:items-start">
    ...
    {/* Testimonial 2 */}
    <blockquote className="animate-fade-in-up animation-delay-300 rounded-2xl bg-white p-8 ring-1 ring-slate-200/60 transition-smooth hover:ring-slate-200 hover:shadow-md scale-on-hover">
      <p className="text-slate-800 leading-relaxed">
    ...
    {/* Testimonial 3 */}
    <blockquote className="animate-fade-in-up animation-delay-400 rounded-2xl bg-white p-8 ring-1 ring-slate-200/60 transition-smooth hover:ring-slate-200 hover:shadow-md scale-on-hover">
      <p className="text-slate-800 leading-relaxed">
    ...
    {/* Testimonial 4 */}
    <blockquote className="animate-fade-in-up animation-delay-500 rounded-2xl bg-slate-50 p-8 ring-1 ring-slate-200/60 transition-smooth hover:ring-slate-200 hover:bg-white hover:shadow-md scale-on-hover">
      <p className="text-slate-800 leading-relaxed">
